...
{
    public static string STARTING_NAMESPACE = "InteractiveMiniGame";
    ...
    public static void OnWillCreateAsset(string path)
    {
        ...
        if (_namespace.StartsWith("Assets/Scripts"))
            _namespace = _namespace.Substring("Assets/Scripts".Length);
        else
            _namespace = _namespace.Substring("Assets".Length);
        _namespace = STARTING_NAMESPACE + _namespace;
